...
{
    originViewController = popupViewController;
    [MainViewController getMianViewShareInstance].assistiveTouchView.hidden = YES;
...
- (void)dismissPopupViewControllerWithanimationType:(MJPopupViewAnimation)animationType
{
    ...
    [MainViewController getMianViewShareInstance].assistiveTouchView.hidden = NO;
