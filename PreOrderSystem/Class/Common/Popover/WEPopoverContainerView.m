...
permittedArrowDirections:(UIPopoverArrowDirection)permittedArrowDirections
	...
	if ((self = [super initWithFrame:CGRectZero])) {
		...
		UIImage *theImage = [UIImage imageFromMainBundleFile:properties.bgImageName];
...
- (void)determineGeometryForSize:(CGSize)theSize anchorRect:(CGRect)anchorRect displayArea:(CGRect)displayArea permittedArrowDirections:(UIPopoverArrowDirection)supportedArrowDirections {	
	...
	UIImage *upArrowImage = [UIImage imageFromMainBundleFile:properties.upArrowImageName];
	UIImage *downArrowImage = [UIImage imageFromMainBundleFile:properties.downArrowImageName];
	UIImage *leftArrowImage = [UIImage imageFromMainBundleFile:properties.leftArrowImageName];
	UIImage *rightArrowImage = [UIImage imageFromMainBundleFile:properties.rightArrowImageName];
